...
public class AdapterForAllBusinessCategory extends RecyclerView.Adapter<AdapterForAllBusinessCategory.MyViewHolder> {
    private final List<PojoCategory> list;
    private final List<PojoCategory> filteredList;
    private final Context context;
    int layoutID = 0;

    public AdapterForAllBusinessCategory(List<PojoCategory> list, Context context, int layoutId) {
        this.list = list;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    changeFragment(new FragmentAllRegistrationInfoByCat());
                }
            });
        }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        PojoCategory list = filteredList.get(position);

        holder.onlineDirectoryName.setText(list.getnAME());
