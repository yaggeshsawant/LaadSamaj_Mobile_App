...
public class AdapterForRegistrationInfo extends RecyclerView.Adapter<AdapterForRegistrationInfo.MyViewHolder> {
    private final Context context;
    private final List<PojoRegistrationInfo> list;
    private final List<PojoRegistrationInfo> filteredList;


    public AdapterForRegistrationInfo(Context context, List<PojoRegistrationInfo> list) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView logoRegImage, regImage;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.addressText.setText(android.text.Html.fromHtml(list.getAddress()).toString().trim());
        holder.productText.setText(android.text.Html.fromHtml(list.getProduct()).toString().trim().replaceAll("@",","));
...
/*
        Glide.with(context)
                ...
                .error(R.drawable.ic_default_logo_reg).into(holder.logoRegImage);*/
    ...
    public void filter(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (PojoRegistrationInfo list : list) {
                if (list.getCompany_name().contains(query)) {
