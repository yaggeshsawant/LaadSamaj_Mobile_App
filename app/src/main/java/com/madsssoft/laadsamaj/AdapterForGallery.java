...
public class AdapterForGallery extends RecyclerView.Adapter<AdapterForGallery.MyViewHolder> {
    Context context;
    int last_position = -1;
    private List<PojoGallery> list;
    private List<PojoGallery> filteredList;
    public AdapterForGallery(List<PojoGallery> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        PojoGallery list = filteredList.get(position);
